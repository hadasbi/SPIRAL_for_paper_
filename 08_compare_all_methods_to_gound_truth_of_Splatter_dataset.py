...
if __name__ == '__main__':
    ...
    true_file = '../SPIRAL_simulated_synthetic_data/true_cluster_table.csv'
    ...
    for method in [
        ...
        if method in [
            ...
            #"Hotspot (model='bernoulli', n_neighbors=30)",
            #"Hotspot (model='bernoulli', n_neighbors=300)",
            'SingleCellHaystack (k=3)', 'SingleCellHaystack (k=5)',
                     ]:
            '''
        ...
        elif method in ['SPIRAL', 'SPIRAL (Jaccard index=0.05)', 'SPIRAL (Jaccard index=0.5)', 'SPIRAL (Jaccard index=0.75)']:
            flag = True
            ...
            elif method=='SPIRAL (Jaccard index=0.05)':
